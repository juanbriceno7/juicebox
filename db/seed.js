...
async function createInitialUsers() {
    try {
      ...
      await createUser({username: 'sandra', password: '2sandy4me', name: "Sandra", location: "San Diego"});
      await createUser({username: 'glamgal', password: 'soglam', name: "Tiffany", location: "Long Beach"});
